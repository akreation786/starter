...
function starter_assets()
{
  if (is_page()) {
    ...
    $starter_template_name = basename(get_page_template());
    if ($starter_template_name == "starter.php") {
      ...
      wp_enqueue_script("easing-jquery-js", get_theme_file_uri("/assets/js/jquery.easing.1.3.js"), array("jqeury"), null, false);
      ...
      wp_enqueue_script("main-js", get_theme_file_uri("/assets/js/main.js"), array("jqeury"), null, true);
    } else {
      wp_enqueue_style("bootstrap-css", get_theme_file_uri("/assets/css/bootstrap.css"));
      wp_enqueue_style("starter", get_stylesheet_uri());
    }
